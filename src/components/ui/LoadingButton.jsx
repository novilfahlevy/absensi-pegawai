...
class LoadingButton extends React.Component {
  render() {
    return (
      <Button type="submit" color={this.props.color} className={`d-flex justify-content-center align-content-center ${this.props.className || ''}`} style={{ position: 'relative' }} disabled={this.props.condition}>
